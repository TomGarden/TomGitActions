...
- [关于 GitHub 的访问权限](https://developer.github.com/apps/about-apps/)
    - [创建私人临时秘钥](https://developer.github.com/apps/building-oauth-apps/creating-an-oauth-app/)
...
### 3.2. github - host
[Github actions `git log ` only output one line](https://github.community/t/github-actions-git-log-only-output-one-line/115487)
